...
export const navItems: NavItem[] = [
  ...
  { href: "/kol", label: "KOL", icon: Megaphone, group: "Kerja" },
  { href: "/offline", label: "Klien Revenue", icon: Store, group: "Kerja" },
  { href: "/calendar", label: "Kalender", icon: CalendarDays, group: "Kerja" },
  { href: "/pulse", label: "Head Dashboard", icon: Gauge, group: "Insight", adminOnly: true },
